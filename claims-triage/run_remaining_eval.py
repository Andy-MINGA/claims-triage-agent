...
CASES_TO_RUN = ["lapsed_policy_denied"]
...
async def main():
    ...
    cases = [c for c in dataset["eval_cases"] if c["eval_case_id"] in CASES_TO_RUN]
    ...
    with open("eval_results_remaining.json", "w", encoding="utf-8") as f:
        json.dump(results, f, indent=2)
    print("\nSaved to eval_results_remaining.json")
